...
public class TaskService {
    @Autowired
    private QualificationTaskRepository qTaskRepo;
    @Autowired
    private ProjectProposalTaskRepository proposalTaskRepo;
    @Autowired
    private QuarterlyProgressReportTaskRepository quarterlyProgressReportTaskRepository;
...
//			}
            ...
            if (t.getQpr().getProposalRef() != null) {
                ti.setFipName(t.getQpr().getProposalRef().getName());
            }

            ti.setQuarter(t.getQpr().getQuarter());
